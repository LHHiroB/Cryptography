...
namespace IOCore.Controls
{
    ...
    /// </summary>
    public partial class ThemeIconTextButton : IOUserControl
    {
        ...
        private static readonly DependencyProperty _textProperty = DependencyProperty.Register(nameof(Text), typeof(string), _type, new(string.Empty,
