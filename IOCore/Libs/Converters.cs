...
namespace IOCore.Libs
{
    ...
    public class DateTimeToTimeStringConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string culture)
        {
            if (value is not DateTime v) return "--/--/--";
            return $"{v.Day:D2}/{v.Month:D2}/{v.Year:D2}";
        }
    ...
    public class PremiumHelpSymbolConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string culture)
        {
            return (value != null && (bool)value) ? Symbol.Help : Symbol.SolidStar;
        }
    ...
    public class PremiumToolTipConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string culture)
        {
            return (value != null && (bool)value) ? null : "Premium feature";
        }
